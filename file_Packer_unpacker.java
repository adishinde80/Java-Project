...
//==============================
//
// FilePackerLogin Class
//
//==============================

class FilePackerLogin extends Template implements ActionListener, Runnable
{
	JButton SUBMIT;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource() == SUBMIT)
		{
			...
			if (value1.equals("FilePackerAdmin") && value2.equals("FilePackerAdmin"))
			{
...
public class FilePackerMain
{
	public static void main(String arg[])
	{
		try
		{
			FilePackerLogin frame = new FilePackerLogin();
